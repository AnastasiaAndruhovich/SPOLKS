package by.andruhovich.icmp.icmp.util;
...
public class SystemUtil {
  ...
  /**
   * Returns the "icmp" directory located in "user.home".
   * On XP Pro: C:\Documents and Settings\Sal\icmp
   * @return File
   */
  private static File getAppHomeDirectoryDirectory () {
    ...
    return new File (userHomeDirectory, "icmp");
  }
}